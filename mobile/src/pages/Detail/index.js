...
const message = `Hi ${incident.name}, I would like to help on the "${incident.title}" case, with a donation of the amount you asked, ${Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD'}).format(incident.value)}.`;
